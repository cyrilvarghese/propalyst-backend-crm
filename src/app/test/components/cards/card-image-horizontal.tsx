...
export default function CardImageHorizontal() {
    return (
        <Card className="w-[560px] h-[304px] flex flex-row gap-4 backdrop-blur-xl bg-black/70 hover:shadow-xl glass-texture transition-shadow duration-300  border-white/20">
            ...
            <CardContent className="pt-6 ">
                < div className="flex flex-row gap-4" >
                    <img
                        ...
                        alt="Cover"
                        className="shadow-sm h-64 w-80 object-cover rounded-xl mb-4"
                    />
