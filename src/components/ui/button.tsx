...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow hover:bg-gradient-to-r hover:from-primary hover:to-primary/80 hover:shadow-lg hover:scale-105",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-gradient-to-br hover:from-destructive hover:to-destructive/80 hover:shadow-lg",
        outline:
        ...
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:bg-gradient-to-br hover:from-secondary hover:to-secondary/70 hover:shadow-lg",
